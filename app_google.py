...
def add_job(n, p, a, f, u, asn, d, is_survey):
    ...
    # Thêm cột is_survey_only vào cuối (giả sử là cột thứ 12 nếu bạn đã thêm trên sheet)
    # Hoặc chỉ cần đảm bảo header trên sheet khớp. Ở đây tôi thêm vào cuối.
...
if not st.session_state['logged_in']:
    ...
    with c2:
        ...
        if st.button("Register"):
            # Đã sửa lỗi Syntax ở đây (tách dòng)
        ...
        try:
            ...
            if df.empty:
                ...
                if my_df.empty:
                    ...
                    k3.metric("🟢 Trong Hạn", len(ontrack), border=True)
